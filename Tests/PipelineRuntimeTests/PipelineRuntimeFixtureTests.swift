...
final class PipelineRuntimeFixtureTests: XCTestCase {
    ...
    func testGeneratedFixtureChartCanBeEvaluatedThroughCorpusRunner() async throws {
        ...
        XCTAssertEqual(corpusReport.totalExpectations, 4)
        XCTAssertEqual(corpusReport.passedExpectations, 1)
        XCTAssertEqual(corpusReport.failedExpectations, 3)
        XCTAssertEqual(corpusReport.missingCharts, ["known-tone:easy", "licensed-breakbeat-a:prototype", "real-review-template:prototype"])
        ...
        XCTAssertTrue(reportText.contains("difficulty_summary easy=0/1/missing=1 prototype=1/3/missing=2"))
        ...
        XCTAssertTrue(reportText.contains("missing known-tone:easy, licensed-breakbeat-a:prototype, real-review-template:prototype"))
    }
